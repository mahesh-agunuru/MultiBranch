        ...
        stage('test') {
            steps {
                echo 'test .'
                 snDevOpsStep()
                sleep 10
               snDevOpsArtifact(artifactsPayload:"""{"artifacts": [{"name": "development_artifact.jar","version": "1.5","semanticVersion": "1.5.0","repositoryName": "development_artifact_repo"}],"stageName": "test"}""")
                //snDevOpsChange()
            }
        }
